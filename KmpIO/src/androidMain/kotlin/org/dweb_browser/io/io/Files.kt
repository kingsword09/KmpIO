...
actual class RawFile actual constructor(
    ...
    private fun acceptRead(buf: org.dweb_browser.io.io.ByteBuffer,
                           bytesRead: Int,
                           javaBuf: ByteBuffer,
                           reuseBuffer: Boolean
    ): UInt {
     ...
     */
    actual suspend fun read(buf: org.dweb_browser.io.io.ByteBuffer, reuseBuffer: Boolean): UInt {
     ...
     * @return number of bytes actually read
     */
    actual suspend fun read(buf: org.dweb_browser.io.io.ByteBuffer, newPos: ULong, reuseBuffer: Boolean): UInt {
        if (reuseBuffer) buf.clear()
        val javaBuf = makeJavaBuffer(buf)
     ...
     */
    actual suspend fun readBuffer(length: UInt): org.dweb_browser.io.io.ByteBuffer {
    ...
    actual suspend fun readBuffer(
        length: UInt,
        newPos: ULong
    ): org.dweb_browser.io.io.ByteBuffer {
        return ByteBuffer(length.toInt()).apply {
    ...
    actual suspend fun write(buf: org.dweb_browser.io.io.ByteBuffer) {
        val javaBuf = makeJavaBuffer(buf)
        val bytesWritten = javaFile.channel.write(javaBuf)
        buf.position += bytesWritten
    }

    actual suspend fun write(buf: org.dweb_browser.io.io.ByteBuffer, newPos: ULong) {
        val javaBuf = makeJavaBuffer(buf)
    ...
    actual suspend fun copyTo(
        ...
        transform: ((buffer: org.dweb_browser.io.io.ByteBuffer, lastBlock: Boolean) -> org.dweb_browser.io.io.ByteBuffer)?
    ): ULong {
    ...
    private fun makeJavaBuffer(buf: org.dweb_browser.io.io.ByteBuffer): ByteBuffer {
